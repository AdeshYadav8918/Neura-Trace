...
Always use the latest version of NeuraTrace for the best security.

## Reporting a Vulnerability

We take the security of NeuraTrace seriously. If you discover a security vulnerability, please follow these steps:
...
NeuraTrace requires API keys for various LLM providers. Follow these practices to keep your credentials secure:
...
NeuraTrace uses comprehensive automated security scanning in our CI/CD pipeline to identify and address vulnerabilities proactively.
...
NeuraTrace is designed for **legitimate threat modeling and security analysis purposes only**. Users should:
